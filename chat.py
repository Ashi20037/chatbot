...
ffmpeg_directory = "C:\\Users\\ashik\\.conda\\envs\\myenv\\Lib\\site-packages\\ffmpeg-2023-10-26-git-2b300eb533-full_build\\bin"
os.environ["PATH"] += os.pathsep + ffmpeg_directory
palm.configure(api_key="AIzaSyAioTGZZz8rOWnT_n7CfR2VBYgEH2p5ngo")
...
iface = gr.Interface(
    fn=handle_input,
    inputs=["text", gr.Audio(source="microphone", label="Ask your question by voice:")],
    outputs="text",
    title="EDU.GPT",
)
